...
import 'package:sembast_no_sql/data/fruite_dao.dart';
...
class FruitBloc extends Bloc<FruitEvent, FruitState> {
  ...
  FruitBloc(FruitState initialState) : super(initialState);
  ...
  void dispatch(UpdateWithRandomFruit updateWithRandomFruit) {}
}
